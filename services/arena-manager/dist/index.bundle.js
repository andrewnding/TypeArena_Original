...
app.listen(!(function webpackMissingModule() { var e = new Error("Cannot find module 'config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).PORT, function () {
  console.log("Listening on port ".concat(!(function webpackMissingModule() { var e = new Error("Cannot find module 'config'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).PORT));
});
